...
const RelatedNews = () => {
    return (
        <>
            <h5 className="mt-10 text-xl font-bold text-primary">Terkait</h5>
            <LineUkm />
            <div className="flex flex-wrap justify-between">
                <div className="mt-5 w-full lg:w-[542px]">
                    ...
                    <h5 className="mt-3 mb-8 cursor-pointer text-[17px] font-bold text-dark hover:text-secondary">
                        Unit Kegiatan Mahasiswa Bidang Seni (UKMBS) Menggelar
                        Festival Band Se-Lampung
                    </h5>
